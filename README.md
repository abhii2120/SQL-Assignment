...
Includes basic SELECT, WHERE, ORDER BY, and simple queries
...
Includes COUNT, SUM, AVG, MIN, MAX, GROUP BY, and HAVING
...
Includes numeric, string, and date functions
...
Includes single-row and multi-row subqueries
...
Contains complete and well-structured SQL queries

Written using proper SQL syntax

Question Paper (PDF)

Original assignment questions for reference

Full Answer & Explanation (PDF)
...
Concept-wise structured learning
...
Combines joins, subqueries, aggregation, and functions

Designed for deeper analytical understanding
